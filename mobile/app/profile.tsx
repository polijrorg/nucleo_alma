    ...
    <SafeAreaView className="flex-1 bg-white" edges={['top']}>
      <View className="flex-1 bg-slate-50">
        <ScrollView contentContainerStyle={{ paddingBottom: 100, paddingHorizontal: 24, paddingTop: 24 }}>
          ...
          <View className="bg-blue-100 w-full rounded-3xl p-6 items-center border border-slate-200 mb-6">
            <View className="w-24 h-24 bg-blue-500 rounded-full justify-center items-center mb-4 border border-slate-200">
